...
public class WireReaderWriterTest
{
    ...
    {
        var ms = new MemoryStream([1, (byte)'a']);
        var reader = new WireReader(ms);
    ...
    public void ReadDateTime48()
    {
        ...
        var ms = new MemoryStream([0x00, 0x00, 0x32, 0xe4, 0x07, 0x00]);
        var reader = new WireReader(ms);
    ...
    {
        var ms = new MemoryStream([1, 0xFF]);
        var reader = new WireReader(ms);
        reader.ReadString();
    }
