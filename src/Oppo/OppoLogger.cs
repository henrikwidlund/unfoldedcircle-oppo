...
internal static partial class OppoLogger
{
    ...
    [LoggerMessage(EventId = 17, EventName = nameof(ReplacingStreamingSubscriber), Level = LogLevel.Trace,
    ...
    [LoggerMessage(EventId = 18, EventName = nameof(UnknownStreamingStatusCode), Level = LogLevel.Debug,
    ...
    [LoggerMessage(EventId = 19, EventName = nameof(ReaderLoopCompletedWithPendingCommand), Level = LogLevel.Warning,
    ...
    [LoggerMessage(EventId = 20, EventName = nameof(ReaderLoopCanceledWithPendingCommand), Level = LogLevel.Debug,
    ...
    [LoggerMessage(EventId = 21, EventName = nameof(ReaderLoopFailedWithPendingCommand), Level = LogLevel.Warning,
